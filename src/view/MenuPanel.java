...
public class MenuPanel extends JPanel implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals(item01_menuA.getActionCommand())) {
            System.exit(0);
        }
        ...
        if (e.getActionCommand().equals(item01_menuC.getActionCommand())) {
